<template>
    <main class="static">
        ...
        <div class="mx-20 my-10 grid md:grid-cols-2 gap-4">
            ...
            <div class="entrybg .dark p-3 bg-bg200 rounded-lg" v-for="(fav, i) in favoriteDrinks"
                :key="i">
                <p class="mb-3 text-center text-xl font-title border-b-1 border-primary200"><b>{{ fav.strDrink }} -
                        {{ fav.idDrink }}</b></p>
                <div class="md:flex flex-row">
                    <div class="p-3 w-full flex justify-center md:flex flex-row md:justify-start">
                        <img class="mr-3 w-[60%] rounded-lg hover:scale-105 duration-500 md:w-[40%]" v-if="fav.strDrinkThumb"
                            :src="fav.strDrinkThumb" alt="" />
                    </div>
                    <button
                        class="bg-primary100 h-[10%] rounded-md p-1 hover:bg-primary200 duration-300 dark:bg-dbg300 dark:hover:bg-dbg100"
        ...
        <div class="mx-20 my-10 grid md:grid-cols-2 gap-4">
            ...
            <div class="entrybg .dark p-3 bg-bg200 rounded-lg" v-for="(fav, i) in favoriteMeals" :key="i">
                <p class="mb-3 text-center text-xl font-title border-b-1 border-primary200"><b>{{ fav.strMeal }} -
                        {{ fav.idMeal }}</b></p>
                <div class="md:flex flex-row">
                    <div class="p-3 w-full flex justify-center md:flex flex-row md:justify-start">
                        <img class="mr-3 w-[60%] rounded-lg hover:scale-105 duration-500 md:w-[40%]" v-if="fav.strMealThumb"
                            :src="fav.strMealThumb" alt="" />
                    </div>
                    <button
                        class="bg-primary100 h-[10%] rounded-md p-1 hover:bg-primary200 duration-300 dark:bg-dbg300 dark:hover:bg-dbg100"
